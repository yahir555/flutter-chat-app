...
_handleSubmit(String texto) {
  ...
  if (authService.usuario == null) {
    // Si el usuario es null, puedes manejar el error aquí, por ejemplo:
  ...
  final newMessage = new ChatMessage(
    uid: authService.usuario!.uid, // Usar el operador `!` porque ya verificamos que no es null
    texto: texto,
  ...
  this.socketService.emit('mensaje-personal', {
    'de': authService.usuario!.uid, // Lo mismo aquí, asegúrate de usar `!` porque ya es seguro
